...
namespace Lab_3
{
    ...
    class Laboratory
    {
        static void Main(string[] args)
        {
            ...
            ushort dayAdd;
            while(!ushort.TryParse(Console.ReadLine(), out  dayAdd))
            {
                Console.Write("Такого года не сущетсвует. Попробуй снова: ");
            }
            ...
            while (flag)
            {
                ushort.TryParse(Console.ReadLine(), out ushort day);
